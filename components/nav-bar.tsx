...
const NavBar = () => {
    ...
    return (
        <nav
            className={`overflow-hidden md:h-screen md:w-72 w-full px-4 p-4 flex flex-col md:border-r-2 fixed justify-between z-50 ${mobileOpen ? "h-screen bg-background" : "h-16"}`}>
