...
const ModulCardModal = ({
    ...
    return (
        ...
        <div>
            ...
            {modul && (
                <div
                    className={`fixed z-50 bg-black/50 rounded-t-xl bottom-0 left-0 md:left-72 right-0 flex justify-center transition-transform transform duration-300 ease-out ${
                    ...
                    <div
                        ...
                        <header className="flex flex-col gap-y-2">
                            <div className="flex flex-row items-center justify-between">
                                <div
                                    className="flex justifycenter bg-flag-red/50 text-flag-red rounded-xl py-1 px-2 w-fit items-center justify-center">
                                    {modulArt}
                                </div>
                            ...
                            <div className="flex flex-row justify-items-start gap-4">
                                ...
                                <p className="text-flag-red">Versuche:</p>
                                <div
                                    className="flex items-center gap-1 pl-2 pr-2 text-xs bg-primary-foreground border rounded-xl p-0.5">
                                    <button
                                        className="flex items-center justify-center font-bold rounded-lg text-card-foreground hover:opacity-80 transition-all ml-1"
                                        onClick={decrease}
                                    >-
                                    </button>
                                    <span className="font-semibold text-center text-card-foreground">{counter}</span>
                                    <button
                                        className="flex items-center justify-center font-bold rounded-lg text-card-foreground hover:opacity-80 transition-all"
                                        onClick={increase}
                                    >+
                                    </button>
                                </div>
