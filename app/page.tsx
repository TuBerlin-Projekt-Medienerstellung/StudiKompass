...
export default function Home() {
    return (
        <main
            className="flex flex-col justify-start p-15 min-h-screen bg-background text-zinc-950  ">
            {/* Background Stuff*/}
            ...
            <div className="text-center max-w-3xl space-y-8">
                ...
                <h1 className="flex flex-row gap-6 w-96 items-center">
                    <div className="relative flex size-24">
                        <Image alt="logo" fill src="/logo/Kompass.svg" className="animate-spin-slow"/>
                    </div>
